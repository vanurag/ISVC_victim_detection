...
\begin{figure}[!ht]
  ...
  \begin{tabular}{cc}
    \hspace{-0.5cm}
    \includegraphics[width=6cm]{img/eps/victim_gps/SIP.eps} &
    \includegraphics[width=6cm]{img/eps/victim_gps/SIP_detections_map.eps} \\
  ...
  \begin{tabular}{c}
    \includegraphics[width=9cm]{img/eps/victim_gps/victim_utm_errors.eps} \\
